export const personalInfo = {
  ...
  heroBullets: [
    ...
    "Live Projects: Jananivaani, Khetify"
  ],
  horizontalStrip: [
    "Product Teardowns & Case Studies",
    "AI-Augmented Workflows & Experimentation",
    "User-Centric Research & Insights",
    "End-to-End Ownership (Jananivaani, Khetify)"
  ]
};
...
export const aboutContent = {
  ...
  bulletsCard: [
    ...
    "Case studies: Uber, Groww, Khetify.",
    "Live products: Jananivaani (AI-driven), Khetify (public site).",
    "Focus: structured discovery, data-informed decisions, user empathy."
  ]
};

export const currentFocus = [
  "Exploring AI-augmented product workflows.",
  "Building and improving Jananivaani as a product capstone.",
...
export const skillsMatrix = [
  {
    ...
    skills: ["Customer Discovery", "Product Roadmapping", "PRD & User Stories", "Wireframing & UX", "A/B Testing & Funnels", "Data Analytics"]
  },
  {
    category: "Tools & Design",
    skills: ["Notion", "Figma", "Jira", "Google Sheets", "Microsoft Excel", "Miro"]
  },
  {
    category: "Technical & AI Stack",
    skills: ["Generative AI Workflows", "LLM Experimentation", "Prompt Engineering", "Python Basics"]
  }
];
