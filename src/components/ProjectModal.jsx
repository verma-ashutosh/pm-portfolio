          ...
          <div className="p-6 overflow-y-auto space-y-6 flex-1 text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
            ...
            {activeTab === 'frameworks' && (
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {(project.frameworks || []).map((fw, idx) => (
                      <div
                        key={idx}
                        className="px-3 py-1.5 rounded-lg bg-emerald-50 dark:bg-emerald-950/80 text-emerald-800 dark:text-emerald-300 text-xs font-semibold border border-emerald-200 dark:border-emerald-800"
                      >
                        {fw}
                      </div>
                    ))}
                ...
                {/* Wireframe Mockup Representation & Figma Embed Readiness */}
                <div>
                  <h4 className="font-heading font-bold text-slate-900 dark:text-white text-base mb-2">
                    Figma Wireframes & Prototype Architecture
                  </h4>
                  {project.figmaEmbedUrl ? (
                    <div className="w-full h-80 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700">
                      <iframe
                    ...
                    <div className="p-5 rounded-xl bg-slate-100 dark:bg-slate-800/80 border border-dashed border-slate-300 dark:border-slate-700 text-center space-y-2.5">
                      <div className="inline-flex p-3 rounded-full bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300">
                      ...
                      <p className="text-[11px] text-slate-500 dark:text-slate-400 max-w-md mx-auto leading-relaxed">
                        Features low & high-fidelity user journeys, e-commerce garment intake flows, trade-in valuation triggers, and interactive component states.
                      </p>
                      {project.prototypeUrl && (
                        <a
                          ...
                          className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#10B981] text-white text-xs font-bold shadow-md hover:bg-emerald-600 transition-colors"
                        >
