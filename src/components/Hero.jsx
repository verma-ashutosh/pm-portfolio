...
export const Hero = () => {
  const metricCards = [
    ...
    },
    {
      ...
      subtitle: "End-to-end product discovery & PRDs",
  ...
  return (
    <section id="hero" className="pt-24 pb-12 sm:pt-28 sm:pb-16 bg-[#F4F5F7] text-[#18181B] border-b border-slate-200/80">
      {/* Full width container minimizing side margins (max 5% padding) */}
      <div className="w-full max-w-[1440px] mx-auto px-4 md:px-8 space-y-10">
        
        {/* Section 2: Main Hero Area (60/40 Split Grid) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          
          {/* Left Column (Content & CTAs) ~ 60% (7 cols) */}
          <div className="lg:col-span-7 space-y-5 text-left">
            
            {/* Tagline Capsule / Pill */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-emerald-50 border border-emerald-200/80 shadow-2xs">
            ...
            {/* H1 Headline */}
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold tracking-tight text-[#18181B] leading-[1.1]">
              Ashutosh Verma: FOUNDING OPERATOR | APM
            </h1>

            {/* Sub-headline with bold key phrases */}
            <p className="text-sm sm:text-base lg:text-lg text-[#52525B] leading-relaxed font-normal max-w-2xl">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              {/* Button 1 (Primary): Solid Black background, White text "Download Resume" */}
              <a
                href={personalInfo.resumePdf}
                download="Ashutosh-Verma-APM-Resume.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-[#18181B] text-white font-bold text-xs hover:bg-[#3F3F46] transition-colors duration-150 cursor-pointer shadow-xs"
              >
                <FileText className="w-4 h-4 text-slate-300" />
                <span>Download Resume</span>
              </a>

              {/* Button 2 (Secondary): White background, Black outline */}
              <a
                href="#product-work"
                className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-white text-[#18181B] border-2 border-[#18181B] font-bold text-xs hover:bg-slate-100 transition-colors duration-150 shadow-2xs"
              >
          ...
          {/* Right Column (Visual/Image & Animated Mind-Map Node Effect) ~ 40% (5 cols) */}
          <div className="lg:col-span-5 flex items-center justify-center relative py-6">
            ...
            {/* Node 1 (Top-Left): Speech Bubble with Sparkles (AI Voice) */}
            <div className="absolute top-2 left-2 sm:left-4 z-20 animate-node-1 flex items-center gap-2 bg-white border border-slate-200/90 px-3 py-2 rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.06)]">
            ...
            {/* Node 2 (Top-Right): Minimalist Wireframe / Layout */}
            <div className="absolute top-2 right-2 sm:right-4 z-20 animate-node-2 flex items-center gap-2 bg-white border border-slate-200/90 px-3 py-2 rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.06)]">
              <div className="p-1.5 rounded-lg bg-slate-100 text-slate-800">
                <Layout className="w-4 h-4 text-slate-700" />
              </div>
              <div className="text-left">
                <p className="text-[10px] font-bold text-[#18181B] leading-none">Figma Wireframes</p>
                <p className="text-[9px] text-slate-500 font-medium">20+ Interactive Screens</p>
              </div>
            </div>

            {/* Node 3 (Bottom-Left): Conversion Funnel */}
            <div className="absolute bottom-2 left-2 sm:left-4 z-20 animate-node-3 flex items-center gap-2 bg-white border border-slate-200/90 px-3 py-2 rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.06)]">
              <div className="p-1.5 rounded-lg bg-slate-100 text-slate-800">
            ...
            {/* Node 4 (Bottom-Right): Kanban Board / Prioritization Matrix */}
            <div className="absolute bottom-2 right-2 sm:right-4 z-20 animate-node-4 flex items-center gap-2 bg-white border border-slate-200/90 px-3 py-2 rounded-xl shadow-[0_2px_10px_rgba(0,0,0,0.06)]">
              <div className="p-1.5 rounded-lg bg-slate-100 text-slate-800">
        ...
        {/* Section 3: Metric Highlight Cards (Placed right below the hero text) */}
        <div className="pt-2">
